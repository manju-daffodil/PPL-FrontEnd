...
class Profile extends ProfileBase {
  render() {
    let { firstname, lastname, email, profilePicture } = this.props.state.userInfo;
    return (
      <View style={Styles.parent}>
        ...
        <View style={{ borderBottomWidth: 2, borderTopWidth: 2, borderColor: "black" }}>
          <View style={{ marginLeft: 10 }}>
            <View style={{ height: 70, width: 70, borderColor: "black", borderWidth: 5, borderRadius: 40, marginTop: 5 }}>

              <Image source={{ uri: `${config.serverURL}/${profilePicture}` }} style={{ width: '100%', height: '100%', borderRadius: 40 }} />
            </View>
